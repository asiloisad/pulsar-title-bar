...
class ThemeManager {
  ...
  static applyCustomColors() {
    ...
    const colorBase = atom.config.get("title-bar.baseColor");
    const colorHi = atom.config.get("title-bar.highlightColor");
    const colorText = atom.config.get("title-bar.textColor");
